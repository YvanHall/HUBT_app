...
public class InfoActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		infoBackIb = (ImageView) findViewById(R.id.info_back_ib);

		infoBackIb.setOnClickListener(this);
		...
		protected void onPostExecute(String result) {
			...
			if (("更新完毕").equals(result)) {
				...
				if (student != null) {
					...
					Toast.makeText(InfoActivity.this, "没有数据", Toast.LENGTH_LONG)
							.show();
				}
			} else {
				Toast.makeText(InfoActivity.this, result, Toast.LENGTH_LONG)
						.show();
			}
	...
	private void getUserIdAndPassWord() {
		...
		SharedPreferences sp = InfoActivity.this.getSharedPreferences(
