...
import com.young.R;
import com.young.drawlayout.searchRoomDrawlayoutFragment;
import com.young.entry.Student;
import com.young.sqlite.DatabaseHelper;

public class SearchRoomActivity extends FragmentActivity implements
		OnClickListener {
	...
	private searchRoomDrawlayoutFragment testFragment;
	...
	private void getUserIdAndPassWord() {
		...
		SharedPreferences sp = SearchRoomActivity.this.getSharedPreferences(
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.login_ib:
			Intent it = new Intent(SearchRoomActivity.this, LoginActivity.class);
		...
		case R.id.room_ib:
			...
			break;
		case R.id.score_ib:
			Intent it2 = new Intent(SearchRoomActivity.this,
			...
			break;
		case R.id.news_ib:
			Intent it3 = new Intent(SearchRoomActivity.this, NewsActivity.class);
			startActivity(it3);
			drawerLayout.closeDrawer(left_menu_layout);
			finish();
			break;
		case R.id.academy_ib:
			Intent it4 = new Intent(SearchRoomActivity.this,
	...
	public void initView() {
		testFragment = new searchRoomDrawlayoutFragment();
	...
	public void initLeftLayout() {
		...
		roomIv = (ImageView) view2.findViewById(R.id.room_iv);
		roomTv = (TextView) view2.findViewById(R.id.room_tv);
		...
		roomTv.setTextColor(this.getResources().getColor(R.color.color_1));
		roomIv.setImageDrawable(this.getResources().getDrawable(
				R.drawable.room_iv_in));
	}
