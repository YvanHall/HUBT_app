...
import com.young.R;
import com.young.drawlayout.newsDrawlayoutFragment;
...
public class NewsActivity extends FragmentActivity implements OnClickListener {
	...
	private newsDrawlayoutFragment testFragment;
	...
	private void getUserIdAndPassWord() {
		...
		SharedPreferences sp = NewsActivity.this.getSharedPreferences(
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.login_ib:
			Intent it = new Intent(NewsActivity.this, LoginActivity.class);
			...
			break;
		case R.id.room_ib:
			Intent it1 = new Intent(NewsActivity.this, SearchRoomActivity.class);
			startActivity(it1);
			drawerLayout.closeDrawer(left_menu_layout);
			finish();
			break;
		case R.id.score_ib:
			Intent it2 = new Intent(NewsActivity.this, ChoseTermsActivity.class);
			startActivity(it2);
			drawerLayout.closeDrawer(left_menu_layout);
			finish();
			break;
		...
		case R.id.academy_ib:
			Intent it3 = new Intent(NewsActivity.this,
	...
	public void initView() {
		testFragment = new newsDrawlayoutFragment();
	...
	public void initLeftLayout() {
		...
		newsTv = (TextView) view2.findViewById(R.id.new_tv);
		newsIv = (ImageView) view2.findViewById(R.id.new_iv);
		...
		newsTv.setTextColor(this.getResources().getColor(R.color.color_1));
		newsIv.setImageDrawable(this.getResources().getDrawable(
				R.drawable.news_iv_in));
	}
